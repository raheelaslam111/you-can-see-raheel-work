...
//    Dialog.confirm(this, _t("Are you sure you want to validate inventory ?"), {
...
//            });
    ...
    _onClickSend() {
    console.log(this.composer,'composer');
            if (this.composer.isLog)
            {
            this.composer.update({ isPostingMessage: false,isLog: true});
            this._postMessage()
            }
            else
            {
                Dialog.confirm(this, _t("are you sure? This will send a message to all followers of this thread."), {
                confirm_callback: async () =>{
                this._postMessage();
                this.composer.update({ isPostingMessage: true,isLog: false});
            }});
            }
    }

//    _onClickSend() {
//    var r=confirm("Are you sure you want to post message?");
//    if (r==true)
//      {
//      this._postMessage();
//      }
...
//    alert("Hello! I am an alert box shortcut!!");
        console.log(this.composer,'composer');
        this.composer.update({ isPostingMessage: false,isLog: true});
        this._postMessage();
    }
